...
import ModalStyle from './ModalPlay.module.scss'
const ModalPlayStyle = cn.bind(ModalStyle)
const style = {
  position: "absolute",
  top: "50%",
  left: "50%",
...
export default function BasicModal({ trailer, children }) {
  ...
  return (
    <div>
      ...
      >
        <Box sx={{...style}} className={ModalPlayStyle("player-wrapper")}>
          <ReactPlayer   width="100%" height="100%" url={trailer} />
        </Box>
      </Modal>
    </div>
  );
