...
import { addUser } from "../../../../../apis/adminUser";
import { Link, useNavigate } from "react-router-dom";
import style from "../AdminAddUser/AdminAddUser.module.scss";
...
function AdminAddUserForm() {
  ...
  const { mutate: handleAddUser,error } = useMutation({
    mutationFn: (values) => {
      ...
      return addUser(valuesForm)
    },
    onSuccess: () => {
      queryClinet.invalidateQueries({ queryKey: ["userList"] });
      Swal.fire(
        'Thêm thành công!',
        'Chúc mừng bạn!',
        'success'
      ...
      <Container maxWidth={"md"}>
        <Grid container spacing={3}>
          ...
          <div style={{display:'flex',justifyContent:'space-between',width:'100%'}}>
            <h2 className={style.title}>Thêm Người Dùng</h2>
          {error && (
        ...
        <div className={style.adminUserFormBtn}>
          ...
          />
          <div className={style.btnAddUser}>
